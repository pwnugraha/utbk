...
class Bank_soal extends AdminBase
{
    ...
    {
        $data['item'] = $this->base_model->get_join_item('result', 'bank_soal.*, category, subject', 'bank_soal.id DESC', 'bank_soal', array('kategori_soal'), array('bank_soal.kategori_soal_id=kategori_soal.id'), array('inner'));
