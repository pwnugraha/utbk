...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url('asset/master/bootstrap-4.5.3/dist/css/bootstrap.min.css')  ?>">
    ...
    <script src="<?= base_url('asset/master/bootstrap-4.5.3/dist/js/bootstrap.bundle.min.js') ?>"></script>
