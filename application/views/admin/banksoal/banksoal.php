                            ...
                            foreach ($item as $i) : ?>
                                <tr>
                                    ...
                                    <td width="1" class="pr-md-5">
                                        <button id="delete" type="button" class="btn btn-default btn-sm" data-url="<?= site_url('manage/bank_soal/delete/' . $i['id']) ?>" data-toggle="modal" data-target="#delete-modal" data-backdrop="static" data-keyboard="false" title="Hapus">
