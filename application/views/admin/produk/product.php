            ...
            <div class="card shadow">
                <div class="card-body">
                    <div class="container-fluid p-0">
                        <div class="row">
                            <div class="col-md-6">
                                <a href="<?= base_url('admin/tambahproduct') ?>" class="text-menu">
                    ...
                    <table class="table mb-0 table-hover">
                        <tr>
                            <td class="pl-md-5">
                                ...
                                <p class="text-biru">Paket 2 Soshum/Saintek</p>
                            </td>
                            <td>
                                <div class="d-inline-block">
                                    <small>Deskripsi</small>
                                    <p class="text-biru">Berisi 3x Tryout UTBK Bidang SOSHUM, Pembahasan, Report IRT full akses, dan konsultasi jurusan</p>
                                </div>
                            </td>
                            <td class="pt-4">
                                <span class="bg-success text-light px-3" style="border-radius: 1em;">ACTIVE</span>
