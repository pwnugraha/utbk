                            ...
                            <?php foreach ($item as $i) : ?>
                                <tr>
                                    ...
                                    <td width="1" class="pr-md-5">
                                        <button id="delete" type="button" class="btn btn-default btn-sm" data-url="<?= site_url('manage/paket_ujian/delete/' . $i['id']) ?>" data-toggle="modal" data-target="#delete-modal" data-backdrop="static" data-keyboard="false" title="Hapus">
                                            <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-trash-fill mt-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
